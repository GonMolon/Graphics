...
void ShadowMapping::preFrame() {} 

void ShadowMapping::postFrame() {} 
...
void ShadowMapping::keyPressEvent(QKeyEvent* e) {
	if(e->key() == Qt::Key_C) {
		lightCamera = *camera();
	}
	glwidget()->update();
...
void ShadowMapping::keyReleaseEvent(QKeyEvent* e) {} 

void ShadowMapping::mouseMoveEvent(QMouseEvent* e) {} 

void ShadowMapping::mousePressEvent(QMouseEvent* e) {} 

void ShadowMapping::mouseReleaseEvent(QMouseEvent* e) {} 

void ShadowMapping::wheelEvent(QWheelEvent* e) {}

void ShadowMapping::loadShaders() {
    vs = new QGLShader(QGLShader::Vertex, this);
    vs->compileSourceFile("plugins/ShadowMapping/ShadowMapping.vert");

    fs = new QGLShader(QGLShader::Fragment, this);
    fs->compileSourceFile("plugins/ShadowMapping/ShadowMapping.frag");
...
void ShadowMapping::drawQuad(const Point& p0, const Point& p1, const Point& p2, const Point& p3) {
