...
void ModelInfo2::postFrame() {
	...
	int x = 15;
	int y = 50;
	painter.drawText(x, y, "Objects: " + QString::number(total_obj));
	painter.drawText(x, y+40, "Poligons: " + QString::number(total_pol));
	painter.drawText(x, y+80, "Vertex: " + QString::number(total_vert));
	painter.drawText(x, y+120, "Tri/Pol: " + QString::number(float(total_tri)/total_pol*100) + "%");
	painter.end();
